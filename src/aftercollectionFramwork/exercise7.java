...
class Book{
    ...
    @Override
    public String toString() {  // toString is a function that convert the data in string
...
class MyLibrary{
    ...
    // here "Book" is Class which is defined above and "books" object.
...
public class exercise7 {
    public static void main(String[] args) {
        ...
        System.out.println(l.books); // printing the collection of books
        l.issueBook(b3, "Harry");
        System.out.println(l.books);// printing the collection of books after issuing the book
